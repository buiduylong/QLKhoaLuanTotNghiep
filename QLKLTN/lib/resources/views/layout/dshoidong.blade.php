...
@section('title', 'Danh sách thành viên hội đồng')
@section('content')
<div class="row">
  <h4 class="fix-title">
    Quản lý hội đồng
    <small>Danh sách hội đồng</small>
  </h4>
</div>         
...
<div class="card">
  <div class="card-body">
    <div class="row">                
      <h4 class="card-title fix-title">Danh sách thành viên hội đồng chấm</h4>
    </div>
