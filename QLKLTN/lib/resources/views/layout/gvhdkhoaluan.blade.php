...
@section('title', 'Khóa luận đang hướng dẫn')
@section('content')
<div class="row">
	<h4 class="fix-title">
		Thông tin khóa luận đang hướng dẫn
		<small>Khóa luận đang hướng dẫn</small>
	</h4>
</div>
<div class="card">
	<div class="card-body">
		<h4 class="fix-title">Khóa luận đang hướng dẫn</h4>
		<div class="">
			<table class="table table-bordered">
				...
				<div class="col-md-6">
					...
					<ul style="list-style-type: none;">
						<li><a>Họ và tên: <span class="pull-right badge badge-success">{{$kls->thanhvien->ten_thanhvien}}</span></a></li>
						<li><a>Mã sinh viên: <span class="pull-right badge badge-success">{{$kls->thanhvien->ma_thanhvien}}</span></a></li>
