...
<head>
	...
	<title>Tạo bảng điểm KLTN | Hệ thống quản lý KLTN</title>
	<!-- plugins:css -->
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<!-- Master -->
					<form action="bienban_diemkl.html" method="">
						<div class="row">
							<h3 class="fix-title">Lựa chọn các thông tin cần thiết để tạo <strong>BẢNG ĐIỂM KHÓA LUẬN TỐT NGHIỆP</strong></h3>
						</div>
						<div class="card">
							<div class="card-body">
								<div class="row">
									<h4 class="text-uppercase fix-title">bộ môn </h4>
									<span>
								...
								<div class="row" >
									...
									<div class="col-md-8" align="center">
										<div class="row">
											<div class="col-md-6">
												<h4 class="text-uppercase " >bảng điểm KLTN ngành</h4>
											</div>

											<div class="col-md-6">
												<select class="form-control" id="">
													<option value="unselect" selected="">Lựa chọn Ngành</option>
										...
										<div class="row">
											<div class="col-md-6">
												<h4 class="text-uppercase" >nhóm</h4>
											</div>
										...
										<div class="row">
											<div class="col-md-6">
												<h4 class="text-uppercase" >năm</h4>
											</div>
								...
								<div class="row">
									<h4 class="fix-title">Chọn sinh viên đã bảo vệ khóa luận tốt nghiệp để in bảng điểm:</h4>
									<div class="col-md-12">										
										<input type="checkbox" name="vehicle1" value="Bike">A24912 - Bùi Duy Long<br>
										<input type="checkbox" name="vehicle2" value="Car" checked>A26052 - Nguyễn Việt Hoàng<br>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-4 fix-p" align="center">
										<h4>Giáo viên chấm điểm<h4>
											<div class="row fix-p2">
												<div class="col-md-6">
													<select class="form-control" id="">
														<option value="unselect" selected="">Lựa chọn giáo viên</option>
														<option>Cao Kim Ánh</option>
														<option>Mai Thúy Nga</option>
													</select>																
												</div>
												<h4>(CHỦ TỊCH HĐ)</h4>
											</div>
